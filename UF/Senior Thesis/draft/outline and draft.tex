...
\[\begin{pmatrix}
    \ell & 0 \\ 0 & 1
\end{pmatrix}\] for a positive integer $\ell$. Then for $f\in\mathcal M_k(N,\chi)$, the function $f\circ\alpha_\ell$ is an element of $\mathcal M_k(\ell N,\chi)$ with
...
\[(f|_k[\alpha_\ell])|_k[\gamma] = (f|_k[\alpha_\ell\gamma\alpha_\ell^{-1}])|_k[\alpha_\ell] = (f|_k[\big(\!\begin{smallmatrix}
    a & b\ell \\ cN & d
\end{smallmatrix}\!\big)])|_k[\alpha_\ell] = \chi(d)f|_k[\alpha_\ell]\] as expected. In this setting, the map $\alpha_\ell$ provides a way to move between $\chi$-eigenspaces at different levels.
...
\begin{lemma}\label{lem: miyake lemma 4.6.6}
    ...
    \begin{equation}
        \begin{tikzcd}[ampersand replacement=\&]
            ...
            \arrow["{\varGamma_0(pN)\big(\!\begin{smallmatrix}1 & 0 \\ 0 & p\end{smallmatrix}\!\big)\varGamma_0(N)}", from=1-1, to=1-4]
            \arrow[from=1-1, to=3-1]
            \arrow[from=1-4, to=3-4]
            \arrow["{\varGamma_0(pM)\big(\!\begin{smallmatrix}1 & 0 \\ 0 & p\end{smallmatrix}\!\big)\varGamma_0(M)}", from=3-1, to=3-4]
            \end{tikzcd}

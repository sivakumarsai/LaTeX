...
What remains is to compactify $Y(\varGamma)$ and to put charts on the resulting compact space, which we do without proof. 
...
\begin{proof}
    The number of cusps of $X(\varGamma)$ is the index of $\varGamma$ in $\slz$. Let $\slz/\varGamma$ act on $\mathbb Q \cup \{\infty\}$ in the usual way. The orbit $(\slz/\varGamma)x$ of $x\in \mathbb Q \cup \{\infty\}$ is given by finitely many
\end{proof}

...
\end{theorem}
\begin{proof}
    Without loss of generality we may take $L$ to be a common multiple of $N$ and $M$. If $p$ is a prime number coprime to $L$, we have from $T_{p^2} = T_pT_p - p^{k-1}\abr{p}\id$ that
    \begin{align*}

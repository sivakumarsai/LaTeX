...
\begin{document}
M 392C Representation Theory, Fall 2025: Dr. David Ben-Zvi's lectures, \TeX ed by Sai Sivakumar. The main goal of these notes was to clarify and even expand on several of the points David made during the lectures.
\tableofcontents
...
\[g\chi_{\hat g}(h) = \chi_{\hat g}(g^{-1}h) = \chi_{\hat g}(g^{-1})\chi_{\hat g}(h)\]

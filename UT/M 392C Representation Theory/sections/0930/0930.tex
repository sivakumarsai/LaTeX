...
evaluated at some fixed time $t$. As $t$ increases, the terminal point should move along a particular curve, which is the commutator.
...
\begin{figure}[h]
  ...
  \draw (-4,1) arc (120:90:2 and 1);
  \node (0) [style=none] at (-3,0.5-0.4) {$g_2$};
  \node (0) [style=none] at (-3,0.5) {$\bullet$};

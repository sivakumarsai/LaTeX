...
Denote by $\Rep(G)$ the category of finite-dimensional complex representations of $G$. The tensor product of representations gives $\Rep(G)$ a monoidal structure. Since we can also define duals of representations, $\Rep(G)$ is a rigid symmetric monoidal category; see the \href{https://ncatlab.org/nlab/show/rigid+monoidal+category}{nLab}.

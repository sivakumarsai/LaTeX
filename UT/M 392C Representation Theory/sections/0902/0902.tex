...
The tensor product of representations gives $\Rep_{\mathbb C}(G)$ (the category of finite-dimensional representations of $G$) a monoidal structure. Since we can also define duals of representations, $\Rep_{\mathbb C}(G)$ is a rigid symmetric monoidal category; see the \href{https://ncatlab.org/nlab/show/rigid+monoidal+category}{nLab}.

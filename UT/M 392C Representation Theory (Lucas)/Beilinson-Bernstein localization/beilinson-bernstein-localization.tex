...
We state the Beilinson-Bernstein localization theorem and provide a couple examples. These notes closely follow \sai{TODO source} and borrow examples from \textit{Four examples of Beilinson-Bernstein localization} by Romanov. Attached is also a rough translation of \textit{Localisation de $\mathfrak{g}$-modules} by Beilinson and Bernstein (appearing page \sai{TODO} onwards) This document was submitted for a final project for a course in Archimedean representation theory, following my presentation on the localization theorem.

\newpage\setcounter{section}{0}
What follows is a rough translation of \textit{Localisation de $\mathfrak{g}$-modules} by Beilinson and Bernstein. Some typographical changes were made and some minor comments added. Contact me if there are any errors.

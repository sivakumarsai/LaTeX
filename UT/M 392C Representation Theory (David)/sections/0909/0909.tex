...
As before, we should also expect difference operators to correspond to multiplier operators after taking the Fourier transform.
...
The Chebyshev polynomials (of the first kind) are special functions, like the characters given by $n\mapsto \exp(2\pi i nx)$ or $x\mapsto \exp(2\pi i nx)$ that interact nicely with the Fourier theory.
